...
namespace hotel.Controllers
{
    public class JuridicaController : Controller
    {
        ...
        public JuridicaController(MyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("cnpj,inscricaoestadual,fundacao,Id,Nome,Fone,Endereco")] Juridica juridica)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("cnpj,inscricaoestadual,fundacao,Id,Nome,Fone,Endereco")] Juridica juridica)
        {
            if (id != juridica.Id)
            {
                return NotFound();
