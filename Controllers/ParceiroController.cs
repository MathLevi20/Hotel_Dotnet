...
namespace hotel.Controllers
{
    public class ParceiroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,tipopessoa,atividade")] Parceiro parceiro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,tipopessoa,atividade")] Parceiro parceiro)
        {
            if (id != parceiro.Id)
            {
                return NotFound();
